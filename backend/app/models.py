...
class MCPClientConfig(BaseModel):
    ...
    prompt_id: Optional[str] = Field(default=None, description="OpenAI stored prompt ID")
    prompt_version: Optional[str] = Field(default="1", description="Stored prompt version")
