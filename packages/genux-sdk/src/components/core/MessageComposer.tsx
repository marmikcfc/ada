...
export const MessageComposer: React.FC<MessageComposerProps> = ({
  ...
  return (
    <div className={`genux-message-composer ${className}`} style={containerStyles}>
      <div style={innerContainerStyles}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', marginRight: cssVars['--genux-spacing-sm'] }}>
          {/* Send Button */}
          <button
            onClick={handleSend}
            disabled={!canSend}
          ...
          >
            {loading ? (
              <span style={{ fontSize: cssVars['--genux-font-size-sm'] }}>...</span>
            ) : (
              <svg 
                width="28" 
                height="28" 
                viewBox="0 0 24 24" 
                fill="none" 
                stroke={canSend ? cssVars['--genux-color-primary'] : '#adb5bd'}
                strokeWidth="2.5" 
                strokeLinecap="round" 
