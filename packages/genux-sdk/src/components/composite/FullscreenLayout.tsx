...
export const FullscreenLayout: React.FC<FullscreenLayoutProps> = ({
  ...
  return (
    <div className={`genux-fullscreen-layout ${className}`} style={containerStyles}>
      {/* Left Column - Thread List */}
      {showLeft && left && (
        <div className="genux-fullscreen-left" style={leftColumnStyles}>
          {left}
        </div>
      )}
      ...
      {showCenter && center && (
        <div className="genux-fullscreen-center" style={centerColumnStyles}>
          {center}
        </div>
      )}
      ...
      {/* Right Column - Chat */}
      {showRight && right && (
        <div className="genux-fullscreen-right" style={rightColumnStyles}>
          {right}
        </div>
      )}
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .genux-fullscreen-left,
          .genux-fullscreen-center {
