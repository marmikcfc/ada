...
const ChatWindow: React.FC<ExtendedChatWindowProps> = ({
  ...
  const windowStyles: CSSProperties = {
    ...
    ...(isFloating
      ? {
          ...
          // slide-in animation
          animation: 'genux-slide-in 0.25s ease-out',
        }
      : {
          top: 0,
          left: 0,
    ...
    overflow: 'hidden',
    zIndex: 10000,
    fontFamily: cssVars['--genux-font-family'],
    ...style,
  };
  ...
  const headerStyles: CSSProperties = {
    ...
    padding: `${cssVars['--genux-spacing-md']} ${cssVars['--genux-spacing-md']}`,
  ...
  const closeButtonStyles: CSSProperties = {
    ...
    color: '#ffffff',
    cursor: 'pointer',
    padding: cssVars['--genux-spacing-xs'],
    borderRadius: cssVars['--genux-radius-full'],
    display: 'flex',
    alignItems: 'center',
  ...
  const typingDotsStyles = `
    ...
    .typing-dots span {
      ...
      height: 6px;
      margin: 0 2px;
      background-color: ${cssVars['--genux-color-textSecondary']};
      border-radius: 50%;
  ...
  return (
    <ThemeProvider mode="dark">
      ...
      <div className={`genux-chat-window ${className}`} style={windowStyles}>
        {/* Header */}
        <div className="genux-chat-header" style={headerStyles}>
          {headerContent || (
            <div className="genux-agent-info" style={agentInfoStyles}>
              {logoUrl && (
        ...
        {/* Main content area */}
        <div className="genux-main-content" style={mainContentStyles}>
          {/* Thread manager sidebar (if enabled) */}
          {showThreadManager && (
            <div className="genux-thread-manager" style={threadManagerStyles}>
          ...
          {/* Chat content area */}
          <div className="genux-chat-content" style={chatContentStyles}>
            {/* Messages container */}
            <div className="genux-messages-container" style={messagesContainerStyles} ref={chatContainerRef}>
              ...
              {(isEnhancing ?? false) || (isLoading ?? false) || (isVoiceLoading ?? false) ? (
                <div className="genux-loading-indicator" style={loadingIndicatorStyles}>
                  <span className="genux-loading-text">
                    {isEnhancing
