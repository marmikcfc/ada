...
import { useGenuxClient, Message } from '../src';

/**
 * Example: Headless Custom UI
 * 
 * This example demonstrates how to use the useGenuxClient hook to build
 * a completely custom chat interface without using any of the default
 * Genux UI components. This gives you full control over the UI while
...
const HeadlessCustomExample: React.FC = () => {
  ...
  // Initialize the Genux client with connection settings
