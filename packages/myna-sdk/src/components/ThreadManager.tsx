...
const ThreadManager: React.FC<ThreadManagerProps> = ({
  ...
  const createButtonStyles: CSSProperties = {
    padding: `${cssVars['--myna-spacing-xs']} ${cssVars['--myna-spacing-sm']}`,
  ...
  const getThreadItemStyles = (isActive: boolean): CSSProperties => ({
    ...
    alignItems: 'center',
    padding: cssVars['--myna-spacing-sm'],
    marginBottom: cssVars['--myna-spacing-xs'],
    borderRadius: cssVars['--myna-radius-md'],
    cursor: 'pointer',
  ...
  const threadMetaStyles: CSSProperties = {
    fontSize: cssVars['--myna-font-size-xs'],
    opacity: 0.8,
    overflow: 'hidden',
    textOverflow: 'ellipsis',
    whiteSpace: 'nowrap',
  ...
  const threadActionsStyles: CSSProperties = {
    ...
    alignItems: 'center',
    gap: cssVars['--myna-spacing-xs'],
    marginLeft: cssVars['--myna-spacing-xs'],
    opacity: 0,
  ...
  const loadingStyles: CSSProperties = {
    ...
    alignItems: 'center',
    justifyContent: 'center',
    padding: cssVars['--myna-spacing-lg'],
  ...
  const hoverStyles = `
    ...
    .thread-item:hover {
      background-color: ${cssVars['--myna-color-surface']} !important;
    }
